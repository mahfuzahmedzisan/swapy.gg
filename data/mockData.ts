import { Game, Listing, User, UserRole, Review, ChatMessage, Category, Platform, PlatformGroup, Order, OrderStatus, Banner } from '../types';
...
export const GAMES: Game[] = [
  { 
    id: '1', name: 'EA Sports FC 24', slug: 'fc24', image: 'https://picsum.photos/300/300?random=1', 
  ...
  { 
    id: '2', name: 'Fortnite', slug: 'fortnite', image: 'https://picsum.photos/300/300?random=2', 
  ...
  { 
    id: '4', name: 'WoW Dragonflight', slug: 'wow', image: 'https://picsum.photos/300/300?random=4', 
